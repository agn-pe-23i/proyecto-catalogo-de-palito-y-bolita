...
def ejecutar_opcion(opcion):
    if opcion == "1":
        catalogo.menu_agregar()  # Llama a la función 'menu_agregar' del módulo 'agregar'
    elif opcion == "2":
        Buscar_y_eliminar.buscar_producto()  # Llama a la función 'buscar_producto' del módulo 'busqueda'
    elif opcion == "3":
        Buscar_y_eliminar.eliminar_producto()  # Llama a la función 'eliminar_producto' del módulo 'eliminacion'
    elif opcion == "4":
        catalogo.mostrar_catalogo()  # Llama a la función 'mostrar_catalogo' del módulo 'mostrar'
    elif opcion == "5":
